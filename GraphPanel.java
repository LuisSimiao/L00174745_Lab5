...
public class GraphPanel extends JComponent {
    ...
    private static class DisplayNode {
        ...
        private static final int X_CHAROFFSET = 5;
        private static final int Y_CHAROFFSET = 5;
        ...
        public void draw(Graphics g) {
            ...
            // Set text color for contrast: white on red, black on black
            ...
            if(hasNodeValue)
            {
                ...
                g.drawString(nodeValue.toString(), p.x - X_CHAROFFSET * numDigits, p.y + Y_CHAROFFSET);
            }
            if (selected) {
                g.setColor(Color.darkGray);
